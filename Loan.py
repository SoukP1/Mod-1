...
print(f"The total amounts is ${total_loan}.")
...
print(f"The average loan amount is ${round(average_loan)}")
...
print(f"Future value of the loan is {future_value} and there are {remaining_months} months left.")
...
if present_value >= loan_price:
    print("Worth the cost to buy it.")
else:
    print("Not worth the price.")
...
print(f"The current value of the loan is {present_value: .2f}")
